...
\foreach \year in \yearstoshow {
    \textbf{\csname\year\endcsname} \ifFirstIteration \global\FirstIterationfalse \else (archived) \fi

    \begin{tabularx}{\textwidth}{|l|X|}
        \hline
        \textbf{Topic} & \textbf{Program Page Link} \\ \hline
        \makecell{Coursework \& Program Requirements} & \makecell{\href{\csname GR\year PHD\endcsname}{Computer Science, Ph.D.}} \\ \hline
        \makecell{Transfer Credit}                    & \makecell{\href{\csname GR\year TC\endcsname}{Transfer Credit}}          \\ \hline
        \makecell{Breadth Courses}                    & \makecell{\href{\csname GR\year BC\endcsname}{Computer Science, Ph.D.}}  \\ \hline
        \makecell{Committee Requirements}             & \makecell{\href{\csname GR\year CR\endcsname}{Committee Requirements}}   \\ \hline
    \end{tabularx}
