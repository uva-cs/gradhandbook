...
\begin{tabularx}{\textwidth}{|l|l|X|}
    ...
    2025-2026 & \makecell{\href{\GRtwentyfiveMS}{Computer Science, M.S.} \\ \href{\GRtwentyfiveCR}{Committee Requirements}} & \href{\GRtwentyfiveMCS}{Computer Science, M.C.S.} \\ \hline
    2024-2025 (archived) & \makecell{\href{\GRtwentyfourMS}{Computer Science, M.S.} \\ \href{\GRtwentyfourCR}{Committee Requirements}} & \href{\GRtwentyfourMCS}{Computer Science, M.C.S.} \\ \hline
    2023-2024 (archived) & \makecell{\href{\GRtwentythreeMS}{Computer Science, M.S.} \\ \href{\GRtwentythreeCR}{Committee Requirements}} & \href{\GRtwentythreeMCS}{Computer Science, M.C.S.} \\ \hline
\end{tabularx}
...
%     % \gappto\mytablecontents{\csname\year\endcsname \ifFirstIteration \global\FirstIterationfalse \else (archived) \fi & \makecell{\href{\csname GR\year MS\endcsname}{Computer Science, M.S.} \\ \href{\csname GR\year CR\endcsname}{Committee Requirements}} & \href{\csname GR\year MCS\endcsname}{Computer Science, M.C.S.}}
%     \gappto\mytablecontents{24 &}
%     \gappto\mytablecontents{\makecell{\href{\csname GR\year MS\endcsname}{Computer Science, M.S.}}}
%     \gappto\mytablecontents{&}
%     \gappto\mytablecontents{\href{\csname GR\year MCS\endcsname}{Computer Science, M.C.S.}}
%     % \gappto\mytablecontents{24 & 54 & \href{ok}{Computer Science, M.C.S.}}
%     % \xappto\mytablecontents{24 & 54 & huh}



%     % \xappto\mytablecontents{A & B & \year}
